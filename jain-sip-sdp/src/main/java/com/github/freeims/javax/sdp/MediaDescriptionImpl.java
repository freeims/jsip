 ...
 *
 */
package com.github.freeims.javax.sdp;
...
public class MediaDescriptionImpl implements javax.sdp.MediaDescription {
     ...
     *
     * @param payloadNames
     *                      a Vector of String - each one the name of a dynamic
     *                      payload to
     *                      be added (usually an integer larger than
     *                      SdpConstants.AVP_DYNAMIC_MIN).
     * @param payloadValues
     *                      a Vector of String - each contains the value describing
     *                      the
     *                      correlated dynamic payloads to be added
     * @throws SdpException
     *                      if either vector is null or empty. if the vector sizes
     *                      are
     *                      unequal.
     */
