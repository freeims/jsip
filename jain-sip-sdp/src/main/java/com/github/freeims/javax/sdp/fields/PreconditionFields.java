 ...
 *
 * <p>
 * For one media description, precondition attributes should
 * be only of one type (segmented or end-to-end)
 * </p>
 * <p>
 * 3GPP TS 24.299,
 * </p>
...
public class PreconditionFields implements Serializable {
     ...
     *
     * <p>
     * If there is an attribute "curr" for the same status-type,
     * the direction-tag is updated with the one supplied.
     * </p>
     *
     ...
     *
     * <p>
     * There can be more than one desired precondition line
     * for a status-type, specially if strength-tag is different.
     * </p>
     *
     * <p>
     * If there is an attribute "des" for the same status-type,
     ...
     * </p>
     * <p>
     * "The confirmation status attribute carries threshold conditions
    ...
    public void setPreconditionConfirmStatus(String status, String direction)
        ...
        for (i = 0; i < preconditionAttributes.size(); i++) {
            ...
            // System.out.println("--> PreconditionField -> (i="+i+") > attribute field: " +
            // af.toString());
        ...
        if (i == preconditionAttributes.size()) {
            ...
            // System.out.println("--> PreconditionField -> new \"conf\" attribute created:
            // " + newAF.toString() );
        }
    }
     ...
     * </p>
     * <p>
     * One attribute field per status-type.
     * (eg: a=curr:qos local none)
     * </p>
     *
     * @param status - (local, remote, e2e)
     ...
     *
     * <p>
     * There can be more than one current precondition line
     * for a status-type (with different direction-tag values),
     * specially if strength-tag is different
     * </p>
     *
     * @param status - (local, remote, e2e)
