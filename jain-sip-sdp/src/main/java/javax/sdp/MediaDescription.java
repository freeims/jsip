...
import com.github.freeims.javax.sdp.fields.AttributeField;
import com.github.freeims.javax.sdp.fields.PreconditionFields;
...
public interface MediaDescription extends Serializable, Cloneable {
        ...
        * null for SessionDescriptions if all Media
        ...
        * RTP/AVP
        * the subType is returned as the codec name. This will either be extracted from
        * the rtpmap attribute or computed.
        * other
        ...
        *                      payload to be added (usually an integer larger
