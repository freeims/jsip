...
import com.github.freeims.core.net.AddressResolver;
import com.github.freeims.core.net.DefaultSecurityManagerProvider;
import com.github.freeims.core.net.NetworkLayer;
import com.github.freeims.core.net.SecurityManagerProvider;
import com.github.freeims.core.net.SslNetworkLayer;
import com.github.freeims.javax.sip.clientauthutils.AccountManager;
import com.github.freeims.javax.sip.clientauthutils.AuthenticationHelper;
import com.github.freeims.javax.sip.clientauthutils.AuthenticationHelperImpl;
import com.github.freeims.javax.sip.clientauthutils.SecureAccountManager;
import com.github.freeims.javax.sip.parser.MessageParserFactory;
import com.github.freeims.javax.sip.parser.PostParseExecutorServices;
import com.github.freeims.javax.sip.parser.StringMsgParser;
import com.github.freeims.javax.sip.parser.StringMsgParserFactory;
import com.github.freeims.javax.sip.stack.ByteBufferFactory;
import com.github.freeims.javax.sip.stack.ClientAuthType;
import com.github.freeims.javax.sip.stack.ConnectionOrientedMessageProcessor;
import com.github.freeims.javax.sip.stack.DefaultMessageLogFactory;
import com.github.freeims.javax.sip.stack.DefaultRouter;
import com.github.freeims.javax.sip.stack.MessageProcessor;
import com.github.freeims.javax.sip.stack.MessageProcessorFactory;
import com.github.freeims.javax.sip.stack.OIOMessageProcessorFactory;
import com.github.freeims.javax.sip.stack.SIPEventInterceptor;
import com.github.freeims.javax.sip.stack.SIPMessageValve;
import com.github.freeims.javax.sip.stack.SIPTransactionStack;
import com.github.freeims.javax.sip.stack.SocketTimeoutAuditor;
import com.github.freeims.javax.sip.stack.timers.DefaultSipTimer;
...
public class SipStackImpl extends SIPTransactionStack implements
	...
	public void addLogAppender(org.apache.log4j.Appender appender) {
		if (this.logger instanceof com.github.freeims.core.LogWriter) {
			((com.github.freeims.core.LogWriter) this.logger).addAppender(appender);
		}
	}
	...
	public org.apache.log4j.Logger getLogger() {
		if (this.logger instanceof com.github.freeims.core.LogWriter) {
			return ((com.github.freeims.core.LogWriter) this.logger).getLogger();
		}
		return null;
	}
