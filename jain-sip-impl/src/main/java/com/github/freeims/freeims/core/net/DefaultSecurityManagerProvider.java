package com.github.freeims.freeims.core.net;
...
public class DefaultSecurityManagerProvider implements SecurityManagerProvider {
    ...
    public void init(Properties properties)
        ...
        // required, could use default keyStore, but it is better practice to explicitly
        // specify
        ...
        if (trustStorePassword == null) {
            logger.logInfo(
                    "javax.net.ssl.trustStorePassword is null, using the password passed through javax.net.ssl.keyStorePassword");
        ...
        if (logger.isLoggingEnabled(LogWriter.TRACE_DEBUG)) {
            logger.logDebug("SecurityManagerProvider " + this.getClass().getCanonicalName() + " will use algorithm "
                    + algorithm);
        }
        ...
        if (logger.isLoggingEnabled(LogWriter.TRACE_DEBUG)) {
            logger.logDebug(
                    "TLS settings OK. SecurityManagerProvider " + this.getClass().getCanonicalName() + " initialized.");
        }
    }
