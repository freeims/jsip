...
import com.github.freeims.freeims.javax.sip.parser.*;
...
public class MessageFactoryImpl implements MessageFactory, MessageFactoryExt {
    ...
    /*
     * The UserAgent header to include for all requests created from this message
     * factory.
     */
     ...
     * @param contentType -
     *                    the new ContentTypeHeader object of the content type value
     *                    of
     *                    this Message.
     ...
     *                    the new integer of the statusCode value of this Message.
     * @param request     -
     *                    the received Reqest object upon which to base the
     *                    Response.
     * @param content     -
     *                    the new Object of the body content value of this Message.
     * @param contentType -
     ...
     *
     * @param requestString --
     *                      string from which to create the message null string
     *                      returns an
     *                      empty message.
     */
    ...
    /**
     * Set the common UserAgent header for all requests created from this message
     * factory.
     * This header is applied to all Messages created from this Factory object
     * except those
    ...
    /**
     * Set the common Server header for all responses created from this message
     * factory.
     * This header is applied to all Messages created from this Factory object
     * except those
     * that take String for an argument and create Message from the given String.
