...
/**
 * Replacement for previous RFC2396UrlDecoder class removed for licensing
 * restrictions, hacked from scratch this time
...
public class UriDecoder {
     ...
     * Decode a uri.
     *
     * Replace %XX (where XX is hexadecimal number) by its corresponding UTF-8
     * encoded bytes.
     * 
        ...
        while (indexOfNextPercent != -1) {
            ...
            if (indexOfNextPercent + 2 < uriToWorkOn.length()) {
                ...
                try {
                    ...
                    String correspondingCharacter = utf8CharSet
                            .decode(ByteBuffer.wrap(new byte[] { hexadecimalNumber })).toString();
