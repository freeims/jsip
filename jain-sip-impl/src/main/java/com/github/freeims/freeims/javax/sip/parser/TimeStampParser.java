 ...
 * Added @author NIST to all API files. Moved a package around in the tck
 * directory.
 *
 * Ranga.
 *
 * Revision 1.2 2006/05/18 10:08:43 mranga
 * Fixes null pointer in comparison when host is not specified. Add methods to
 * allow longs and ints as args in TimeStamp Header.
 *
 * Ranga.
 *
