...
import com.github.freeims.freeims.javax.sip.stack.SSLStateMachine.MessageSendCallback;
...
public class NioTlsWebSocketMessageChannel extends NioWebSocketMessageChannel implements NioTlsChannelInterface {
	...
	public void init(boolean clientMode) throws Exception, CertificateException, FileNotFoundException, IOException {
		...
		String auth = ((SipStackImpl) super.sipStack).getConfigurationProperties()
				.getProperty("org.freeims.javax.sip.TLS_CLIENT_AUTH_TYPE");
		...
		String clientProtocols = ((SipStackImpl) super.sipStack)
				.getConfigurationProperties().getProperty("org.freeims.javax.sip.TLS_CLIENT_PROTOCOLS");
	...
	public void sendEncryptedData(byte[] msg) throws IOException {
		...
		if (logger.isLoggingEnabled(LogWriter.TRACE_DEBUG)) {
			logger.logDebug(
					"sendEncryptedData " + " this = " + this + " peerPort = " + peerPort + " addr = " + peerAddress);
		}
