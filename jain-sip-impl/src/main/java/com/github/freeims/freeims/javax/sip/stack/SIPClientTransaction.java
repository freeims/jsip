...
import com.github.freeims.freeims.javax.sip.ClientTransactionExt;
...
public interface SIPClientTransaction extends ClientTransactionExt, SIPTransaction, ServerResponseInterface {
   ...
   * not use the
   * connection for outgoing requests in this time period) and calls the
   * superclass to set
   * state.
   */
   ...
   * message. A
   * Response with a tag mismatch should be dropped if a Dialog has been created
   * for the
   * original request.
   * 
