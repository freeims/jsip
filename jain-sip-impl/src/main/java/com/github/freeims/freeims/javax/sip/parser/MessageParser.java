...
/**
 * Interface defining the contract for the stack to interact with the message
 * parser to parse a byte array containing the SIP Message
...
public interface MessageParser {
	 ...
	 * @param exhandler Callback if an exception occurs during the parsing to notify
	 *                  back the stack
