 ...
 * default implementatation
 * of this interface can be replaced using the
 * gov.nist.javax.sip.LOG_RECORD_FACTORY property.
 * This override is provided to allow applications to log axuiliary information
 * (such as environment
