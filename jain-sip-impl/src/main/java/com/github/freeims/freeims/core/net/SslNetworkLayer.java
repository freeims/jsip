...
/**
 * extended implementation of a network layer that allows to define a private
 * java
...
public class SslNetworkLayer implements NetworkLayer {
    ...
    public SSLSocket createSSLSocket(InetAddress address, int port,
        ...
        if (myAddress != null) {
            // trying to bind to the correct ipaddress (in case of multiple vip addresses by
            // example)
     ...
     *                     (exception relayed from the correspoonding Socket
     *                     methods)
     */
    public Socket createSocket(InetAddress address, int port,
