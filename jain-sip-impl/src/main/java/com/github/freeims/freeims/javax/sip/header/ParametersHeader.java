...
import com.github.freeims.freeims.core.DuplicateNameValueList;
...
public abstract class ParametersHeader
     ...
     * (non-Javadoc)
     * 
     * @see gov.nist.javax.sip.header.ParametersExt#getParameter(java.lang.String,
     * boolean)
     */
     ...
     * all other headers that may have multiple header parameters of the same name,
     * but
     * with multiple possible values.
     * 
     * Example: P-Charging-Function-Addresses: ccf=[5555::b99:c88:d77:e66];
