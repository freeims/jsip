...
/**
 * A helper interface that provides useful functionality for clients that need
 * to authenticate
 * with servers.
 *
 * @author Emil Ivov
...
public interface AuthenticationHelper {
     ...
     *                              will keep a reference to the generated
     *                              credentials in a cache.
     *                              If you specify -1, then the authentication
     *                              credentials are cached
     *                              until you remove them from the cache. If you
     *                              choose this option, make sure
     *                              you remove the cached headers or you will have a
     *                              memory leak.
     *
     * @return a transaction containing a re-originated request with the
     *         necessary authorization header.
     * @throws SipException
     *                              if we get an exception white creating the new
     *                              transaction
     ...
     *                              you remove the cached headers or you will have a
     *                              memory leak.
     * @param useLooseRouting       avoid setting maddr and port on the request uri
