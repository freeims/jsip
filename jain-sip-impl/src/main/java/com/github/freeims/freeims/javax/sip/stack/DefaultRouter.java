...
import com.github.freeims.freeims.javax.sip.address.*;
...
public class DefaultRouter implements Router {
    ...
    public DefaultRouter(SipStack sipStack, String defaultRoute) {
        ...
        if (defaultRoute != null) {
            try {
                ...
                // The outbound proxy is optional. If specified it should be
                // host:port/transport.
                logger
                        .logError(
    ...
    protected final Hop createHop(SipURI sipUri, Request request) {
        ...
        String transport = sipUri.isSecure() ? SIPConstants.TLS
                : sipUri
                        .getTransportParam();
        if (transport == null) {
            // @see issue 131
