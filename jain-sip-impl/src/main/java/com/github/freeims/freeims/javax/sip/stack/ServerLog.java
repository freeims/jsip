...
import com.github.freeims.freeims.javax.sip.LogRecord;
import com.github.freeims.freeims.javax.sip.header.CallID;
import com.github.freeims.freeims.javax.sip.message.SIPMessage;

/**
 * Log file wrapper class. Log messages into the message trace file and also
 * write the log into
 * the debug file if needed. This class keeps an XML formatted trace around for
 * later access via
...
public class ServerLog implements ServerLogger {
    ...
    private void setProperties(Properties configurationProperties) {
        ...
        this.logFileName = configurationProperties.getProperty("org.freeims.javax.sip.SERVER_LOG");
        String logLevel = configurationProperties.getProperty("org.freeims.javax.sip.TRACE_LEVEL");
        String logContent = configurationProperties
                .getProperty("org.freeims.javax.sip.LOG_MESSAGE_CONTENT");
            ...
            if (printWriter == null) {
                boolean overwrite = Boolean.valueOf(
                        configurationProperties.getProperty(
                                "org.freeims.javax.sip.SERVER_LOG_OVERWRITE"));
                    ...
                    if (sipStack.isLoggingEnabled(LogWriter.TRACE_DEBUG)) {
                        stackLogger
                                .logDebug("Here are the stack configuration properties \n"
                                        ...
                                        + "\n"
                                        + "org.freeims.javax.sip.CACHE_CLIENT_CONNECTIONS= "
                                        + configurationProperties
                                                .getProperty("org.freeims.javax.sip.CACHE_CLIENT_CONNECTIONS")
                                        + "\n"
                                        + "org.freeims.javax.sip.CACHE_SERVER_CONNECTIONS= "
                                        + configurationProperties
                                                .getProperty("org.freeims.javax.sip.CACHE_SERVER_CONNECTIONS")
                                        + "\n"
                                        + "org.freeims.javax.sip.REENTRANT_LISTENER= "
                                        + configurationProperties
                                                .getProperty("org.freeims.javax.sip.REENTRANT_LISTENER")
                                        + "org.freeims.javax.sip.THREAD_POOL_SIZE= "
                                        + configurationProperties
    ...
    /**
     * Global check for whether to log or not. To minimize the time return false
     * here.
     *
    ...
    /**
     * Log a message into the log directory. Time stamp associated with the message
     * is the current
     * time.
     *
     * @param message a SIPMessage to log
    ...
    /**
     * Set aux information. Auxiliary information may be associated with the log
     * file. This is
