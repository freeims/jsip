...
public class HeaderFactoryImpl implements HeaderFactory, HeaderFactoryExt {
    ...
    public javax.sip.header.ExtensionHeader createExtensionHeader(
        ...
        com.github.freeims.freeims.javax.sip.header.ExtensionHeaderImpl ext = new com.github.freeims.freeims.javax.sip.header.ExtensionHeaderImpl();
        ext.setName(name);
        ext.setValue(value);
    ...
    /**
     * @deprecated
     * @see javax.sip.header.HeaderFactory#createRAckHeader(int, int,
     *      java.lang.String)
     */
     ...
     * @throws ParseException which signals that an error has been reached
     *                        unexpectedly while parsing the protocol, cause or text
     *                        value.
    ...
    public javax.sip.header.Header createHeader(
        ...
        String hdrText = new StringBuilder()
                .append(headerName)
                .append(":")
                .append(headerValue)
                .toString();
     ...
     * @param address -- address for the header.
     *
     *                TODO: Once interfaces are in javax, change the type to
     *                MinSEHeader
     *                and add to HeaderFactory. - pmusgrave
     * 
     */
    ...
    // (contributed by Miguel Freitas - PT Inovacao and Telecommunications
    ////////////////////////////////////////////////////////////////////////// Institute)
    ///////////////////////////////////////////////////////////////////////////
