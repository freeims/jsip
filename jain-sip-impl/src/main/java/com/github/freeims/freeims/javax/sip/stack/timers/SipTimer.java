...
*
*/
package com.github.freeims.freeims.javax.sip.stack.timers;

import java.util.Properties;

import com.github.freeims.freeims.javax.sip.SipStackImpl;
import com.github.freeims.freeims.javax.sip.stack.SIPStackTimerTask;

/**
 * Interface to implement to plug a new Timer implementation. currently the ones
 * provided with the stack are based on java.util.Timer
...
public interface SipTimer {
	...
	/**
	 * Start the SIP Timer, called when the stack is created. The stack
	 * configuration is passed
	 * so that different implementations can use specific config properties to
