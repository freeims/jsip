 ...
 * handle each new
 * connection. This is the active object that creates new TCP MessageChannels
 * (one for each new
 * accept socket).
 * 
    ...
    public void run() {
        ...
        while (this.isRunning) {
            try {
                ...
                TCPMessageChannel newChannel = new TCPMessageChannel(newsock, sipStack, this,
                        "TCPMessageChannelThread-" + nConnections);
                if (logger.isLoggingEnabled(LogWriter.TRACE_DEBUG))
