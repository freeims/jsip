...
public class RequestLine extends SIPObject implements SipRequestLine {
     ...
     * 
     * @see
     * gov.nist.javax.sip.header.SipRequestLine#setUri(gov.nist.javax.sip.address.
     * GenericURI)
     */
 ...
 * Issue number: 222
 * Add HeaderFactoryExt.createStatusLine(String) and
 * HeaderFactoryExt.createRequestLine(String)
 ...
 * Changed the encode() and encodeBody() methods of SIP headers and basic
 * classes to make them use the same StringBuilder instance during the encoding
 * phase.
 *
