 ...
 * safely used in
 * the interim between now and the next release. SipStackImpl implements this
 * interface.
 *
...
public interface SipStackExt extends SipStack {
         ...
         * register custom
         * lookup schemes ( for example DNS SRV lookup ) that are not directly supported
         * by the JDK.
         *
         ...
         * one set of
         * suites. These are not validated against the supported cipher suites of the
         * java runtime, so
