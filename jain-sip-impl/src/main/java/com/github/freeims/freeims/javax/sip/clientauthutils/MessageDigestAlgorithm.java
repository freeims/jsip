package com.github.freeims.freeims.javax.sip.clientauthutils;
...
public class MessageDigestAlgorithm {
     ...
     *                                challenge.
     * @param cnonce_value            an optional client-chosen value whose purpose
     *                                is to foil chosen
     *                                plaintext attacks.
     ...
     * @param qop_value               Indicates what "quality of protection" the
     *                                client has applied to the
     *                                message.
     * @param nc_value                the hexadecimal count of the number of
     ...
     * @param nonce_value      A server-specified data string provided in the
     *                         challenge.
     * @param cnonce_value     an optional client-chosen value whose purpose is to
     *                         foil chosen
     *                         plaintext attacks.
     * @param method           the SIP method of the request being challenged.
     * @param digest_uri_value the value of the "uri" directive on the Authorization
     *                         header in the
     *                         request.
     * @param entity_body      the entity-body
     ...
     *                         request) that the client has sent with the nonce
