 ...
 *
 */
package com.github.freeims.freeims.javax.sip.stack;
...
import com.github.freeims.freeims.core.CommonLogger;
import com.github.freeims.freeims.core.InternalErrorHandler;
import com.github.freeims.freeims.core.LogLevels;
import com.github.freeims.freeims.core.LogWriter;
import com.github.freeims.freeims.core.ServerLogger;
import com.github.freeims.freeims.core.StackLogger;
import com.github.freeims.freeims.javax.sip.SIPConstants;
import com.github.freeims.freeims.javax.sip.SipProviderImpl;
import com.github.freeims.freeims.javax.sip.SipStackImpl;
import com.github.freeims.freeims.javax.sip.address.AddressFactoryImpl;
import com.github.freeims.freeims.javax.sip.header.Via;
import com.github.freeims.freeims.javax.sip.message.SIPMessage;
import com.github.freeims.freeims.javax.sip.message.SIPRequest;
import com.github.freeims.freeims.javax.sip.message.SIPResponse;
import com.github.freeims.freeims.javax.sip.stack.SIPClientTransactionImpl.ExpiresTimerTask;
...
public abstract class SIPTransactionImpl implements SIPTransaction {
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getBranchId()
     */
    @Override
    ...
    class MaxTxLifeTimeListener extends SIPStackTimerTask {
        ...
        public void runTask() {
            try {
                if (logger.isLoggingEnabled(LogWriter.TRACE_DEBUG)) {
                    logger.logDebug("Fired MaxTxLifeTimeListener for tx " + sipTransaction + " , tx id "
                            + sipTransaction.getTransactionId() + " , state " + sipTransaction.getState());
                }
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#cleanUp()
     */
    @Override
    public abstract void cleanUp();

    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#setOriginalRequest(com.github.freeims.freeims.javax.sip.message.SIPRequest)
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getOriginalRequest()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getRequest()
     */
    @Override
    public Request getRequest() {
        if (isReleaseReferences() && originalRequest == null && originalRequestBytes != null) {
            if (logger.isLoggingEnabled(StackLogger.TRACE_WARN)) {
                logger.logWarning("reparsing original request " + originalRequestBytes
                        + " since it was eagerly cleaned up, but beware this is not efficient with the aggressive flag set !");
            }
            try {
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#isDialogCreatingTransaction()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#isInviteTransaction()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#isCancelTransaction()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#isByeTransaction()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getMessageChannel()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#setBranch(java.lang.String)
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getBranch()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getMethod()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getCSeq()
     */
    @Override
    public long getCSeq() {
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#setState(int)
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getInternalState()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getState()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#disableRetransmissionTimer()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#disableTimeoutTimer()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#fireTimer()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#isTerminated()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getHost()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getKey()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getPort()
     */
    @Override
    public int getPort() {
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getSIPStack()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getPeerAddress()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getPeerPort()
     */
    @Override
    ...
    // @@@ hagai
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getPeerPacketSourcePort()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getPeerPacketSourceAddress()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getTransport()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#isReliable()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getViaHeader()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#sendMessage(com.github.freeims.freeims.javax.sip.message.SIPMessage)
     */
    @Override
    public void sendMessage(final SIPMessage messageToSend) throws IOException {
        ...
        try {
            ...
            for (MessageProcessor messageProcessor : sipStack
                ...
                boolean addrmatch = messageProcessor.getIpAddress().getHostAddress().toString()
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#addEventListener(com.github.freeims.freeims.javax.sip.stack.SIPTransactionEventListener)
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#removeEventListener(com.github.freeims.freeims.javax.sip.stack.SIPTransactionEventListener)
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#raiseErrorEvent(int)
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#isServerTransaction()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getDialog()
     */
    @Override
    public abstract Dialog getDialog();

    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#setDialog(com.github.freeims.freeims.javax.sip.stack.SIPDialog,
     *      java.lang.String)
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getRetransmitTimer()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getViaHost()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getLastResponse()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getResponse()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getTransactionId()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#hashCode()
     */
    @Override
    public int hashCode() {
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getViaPort()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#doesCancelMatchTransaction(com.github.freeims.freeims.javax.sip.message.SIPRequest)
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#setRetransmitTimer(int)
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#close()
     */
    @Override
    public void close() {
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#isSecure()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getMessageProcessor()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#setApplicationData(java.lang.Object)
     */
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getApplicationData()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#setEncapsulatedChannel(com.github.freeims.freeims.javax.sip.stack.MessageChannel)
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getSipProvider()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#raiseIOExceptionEvent()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#acquireSem()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#releaseSem()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#passToListener()
     */
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#setPassToListener()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#testAndSetTransactionTerminatedEvent()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getCipherSuite()
     */
    @Override
    public String getCipherSuite() throws UnsupportedOperationException {
        if (this.getMessageChannel() instanceof TLSMessageChannel) {
            if (((TLSMessageChannel) this.getMessageChannel()).getHandshakeCompletedListener() == null)
                return null;
            else if (((TLSMessageChannel) this.getMessageChannel()).getHandshakeCompletedListener()
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getLocalCertificates()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getPeerCertificates()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#extractCertIdentities()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#isMessagePartOfTransaction(com.github.freeims.freeims.javax.sip.message.SIPMessage)
     */
    @Override
     ...
     */
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#isReleaseReferences()
     */
    @Override
     ...
     */
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#setReleaseReferences(boolean)
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getTimerD()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getTimerT2()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getTimerT4()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#setTimerD(int)
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#setTimerT2(int)
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#setTimerT4(int)
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getBaseTimerInterval()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getT4()
     */
    @Override
    public int getT4() {
        return this.T4;
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getT2()
     */
    @Override
    public int getT2() {
        return this.T2;
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getTimerI()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getTimerK()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#setForkId(java.lang.String)
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getForkId()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#scheduleMaxTxLifeTimeTimer()
     */
    @Override
    public void scheduleMaxTxLifeTimeTimer() {
        if (maxTxLifeTimeListener == null && this.getMethod().equalsIgnoreCase(Request.INVITE)
            ...
            if (logger.isLoggingEnabled(LogWriter.TRACE_DEBUG)) {
                logger.logDebug("Scheduling MaxTxLifeTimeListener for tx " + this + " , tx id "
                        + this.getTransactionId() + " , state " + this.getState());
            }
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#cancelMaxTxLifeTimeTimer()
     */
    @Override
    public void cancelMaxTxLifeTimeTimer() {
        if (maxTxLifeTimeListener != null) {
            if (logger.isLoggingEnabled(LogWriter.TRACE_DEBUG)) {
                logger.logDebug("Cancelling MaxTxLifeTimeListener for tx " + this + " , tx id "
                        + this.getTransactionId() + " , state " + this.getState());
            }
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getMergeId()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#getAuditTag()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#setAuditTag(long)
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPServerTransaction#isTransactionMapped()
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPServerTransaction#setTransactionMapped(boolean)
     */
    @Override
    ...
    /**
     * @see com.github.freeims.freeims.javax.sip.stack.SIPTransaction#setCollectionTime(int)
     */
    @Override
