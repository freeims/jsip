 ...
 ******************************************************************************/
package com.github.freeims.freeims.javax.sip.message;
...
import com.github.freeims.freeims.javax.sip.Utils;
import com.github.freeims.freeims.javax.sip.header.AlertInfo;
import com.github.freeims.freeims.javax.sip.header.Authorization;
import com.github.freeims.freeims.javax.sip.header.CSeq;
import com.github.freeims.freeims.javax.sip.header.CallID;
import com.github.freeims.freeims.javax.sip.header.Contact;
import com.github.freeims.freeims.javax.sip.header.ContactList;
import com.github.freeims.freeims.javax.sip.header.ContentLength;
import com.github.freeims.freeims.javax.sip.header.ContentType;
import com.github.freeims.freeims.javax.sip.header.ErrorInfo;
import com.github.freeims.freeims.javax.sip.header.ErrorInfoList;
import com.github.freeims.freeims.javax.sip.header.From;
import com.github.freeims.freeims.javax.sip.header.InReplyTo;
import com.github.freeims.freeims.javax.sip.header.MaxForwards;
import com.github.freeims.freeims.javax.sip.header.Priority;
import com.github.freeims.freeims.javax.sip.header.ProxyAuthenticate;
import com.github.freeims.freeims.javax.sip.header.ProxyAuthorization;
import com.github.freeims.freeims.javax.sip.header.ProxyRequire;
import com.github.freeims.freeims.javax.sip.header.ProxyRequireList;
import com.github.freeims.freeims.javax.sip.header.RSeq;
import com.github.freeims.freeims.javax.sip.header.RecordRouteList;
import com.github.freeims.freeims.javax.sip.header.RetryAfter;
import com.github.freeims.freeims.javax.sip.header.Route;
import com.github.freeims.freeims.javax.sip.header.RouteList;
import com.github.freeims.freeims.javax.sip.header.SIPETag;
import com.github.freeims.freeims.javax.sip.header.SIPHeader;
import com.github.freeims.freeims.javax.sip.header.SIPHeaderList;
import com.github.freeims.freeims.javax.sip.header.SIPHeaderNamesCache;
import com.github.freeims.freeims.javax.sip.header.SIPIfMatch;
import com.github.freeims.freeims.javax.sip.header.Server;
import com.github.freeims.freeims.javax.sip.header.Subject;
import com.github.freeims.freeims.javax.sip.header.To;
import com.github.freeims.freeims.javax.sip.header.Unsupported;
import com.github.freeims.freeims.javax.sip.header.UserAgent;
import com.github.freeims.freeims.javax.sip.header.Via;
import com.github.freeims.freeims.javax.sip.header.ViaList;
import com.github.freeims.freeims.javax.sip.header.WWWAuthenticate;
import com.github.freeims.freeims.javax.sip.header.Warning;
import com.github.freeims.freeims.javax.sip.parser.HeaderParser;
import com.github.freeims.freeims.javax.sip.parser.ParserFactory;
import com.github.freeims.freeims.javax.sip.parser.PipelinedMsgParser;
import com.github.freeims.freeims.javax.sip.parser.StringMsgParser;
...
public abstract class SIPMessage extends MessageObject implements javax.sip.message.Message,
    ...
    /**
     * The application data pointer. This is un-interpreted by the stack. This is
     * provided as a
    ...
    /**
     * Get A dialog identifier constructed from this messsage. This is an id that
     * can be used to
     * identify dialogs.
     *
     * @param isServerTransaction is a flag that indicates whether this is a server
     *                            transaction.
     */
     ...
     * match against.
     * This method allows you to do pattern matching with incoming SIP messages.
     * Null matches wild
     * card.
     *
    ...
    /**
     * Encode this message as a string. This is more efficient when the payload is a
     * string
     * (rather than a binary array of bytes). If the payload cannot be encoded as a
     * UTF-8 string
    ...
    /**
     * Encode the message as a byte array. Use this when the message payload is a
     * binary byte
     * array.
     *
     * @return The Canonical byte array representation of the message (including the
     *         canonical
     *         byte array representation of the SDP payload if it exists all in one
     *         contiguous
     *         byte array).
     */
     ...
     * message are
     * cloned. You can modify the cloned copy without affecting the original. The
     * content is
     * handled as follows: If the content is a String, or a byte array, a new copy
     * of the content
     * is allocated and copied over. If the content is an Object that supports the
     * clone method,
     * then the clone method is invoked and the cloned content is the new content.
     * Otherwise, the
    ...
    public Object clone() {
        ...
        retval.peerPacketSourceAddress = this.peerPacketSourceAddress;
        retval.peerPacketSourcePort = this.peerPacketSourcePort;
        return retval;
    }
     ...
     * generated structure).
     *
     * @return Formatted string representation of the object. Note that this is NOT
     *         the same as
    ...
    /**
     * Constructor: Initializes lists and list headers. All the headers for which
     * there can be
     * multiple occurances in a message are derived from the SIPHeaderListClass. All
     * singleton
     ...
     * structure. This is
     * equivalent to the attachHeader(SIPHeader,replaceflag,false); which is the
     * normal way in
    ...
    /**
     * Attach the header to the SIP Message structure at a specified position in its
     * list of
     * headers.
     *
     ...
     * @exception SIPDuplicateHeaderException if the header is of a type that cannot
     *                                        tolerate
     *                                        duplicates and one of this type
     *                                        already exists (e.g. CSeq header).
     * @throws IndexOutOfBoundsException If the index specified is greater than the
     *                                   number of
     ...
     *         From,To,Via and
     *         RequestURI portions of this message as specified in RFC 2543: All
     *         responses to a
     *         request contain the same values in the Call-ID, CSeq, To, and From
     *         fields (with the
     *         possible addition of a tag in the To field (section 10.43)). This
     *         allows responses
     *         to be matched with requests. Incorporates a bug fix for a bug sent in
     *         by Gordon
     *         Ledgard of IPera for generating transactionIDs when no port is
     *         present in the via
     *         header. Incorporates a bug fix for a bug report sent in by Chris
     *         Mills of Nortel
     *         Networks (converts to lower case when returning the transaction
     *         identifier).
     *
     * @return a string that can be used as a transaction identifier for this
     *         message. This can be
     *         used for matching responses and requests (i.e. an outgoing request
     *         and its matching
    ...
    /**
     * Override the hashcode method ( see issue # 55 ) Note that if you try to use
     * this method
     * before you assemble a valid request, you will get a constant ( -1 ). Beware
     * of placing any
    ...
    /**
     * Get the contact header ( the first contact header) which is all we need for
     * the most part.
     *
     */
     ...
     * header with a
     * specified charset, and if the payload has been read as a byte array, then it
     * is returned
    ...
    /**
     * Get the message content as an array of bytes. If the payload has been read as
     * a String then
     * it is decoded using the charset specified in the content type header if it
     * exists.
    ...
    /**
     * Get a header of the given name as a string. This concatenates the headers of
     * a given type
     ...
     *
     * @return a list iterator to a list of header names. These are ordered in the
     *         same order as
    ...
    /**
     * Set the application data pointer. This method is not used the stack. It is
     * provided as a
     * convenient way of storing book-keeping data for applications. Note that null
     * clears the
     * application data pointer (releases it).
     *
     * @param applicationData -- application data pointer to set. null clears the
     *                        application data
     *                        pointer.
     */
