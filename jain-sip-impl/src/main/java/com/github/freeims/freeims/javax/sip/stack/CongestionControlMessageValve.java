 ...
 * stop traffic when the number of
 * server transactions reaches the limit specified in
 * gov.nist.javax.sip.MAX_SERVER_TRANSACTIONS without breaking
 * existing dialogs.
 * 
 * The drop policy is specified in DROP_RESPONSE_STATUS where "0" means silent
 * drop and any positive number will be
 ...
 * 
 * It is advised to extend this class to add your application-specific control
 * conditions
 * 
...
public class CongestionControlMessageValve implements SIPMessageValve {
	...
	public void init(SipStack stack) {
		...
		String dropResponseStatusString = sipStack.getConfigurationProperties().getProperty("DROP_RESPONSE_STATUS",
				"503");
