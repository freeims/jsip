...
import com.github.freeims.freeims.core.ThreadAuditor;
...
import com.github.freeims.freeims.javax.sip.header.StatusLine;
...
import com.github.freeims.freeims.javax.sip.parser.MessageParser;
import com.github.freeims.freeims.javax.sip.parser.ParseExceptionListener;
...
public class UDPMessageChannel extends MessageChannel implements
    ...
    private void processIncomingDataPacket(DatagramPacket packet)
        ...
        if (sipMessage instanceof SIPRequest) {
            ...
            try {
                ...
                if (hasRPort
                    ...
                    topMostVia.setParameter(Via.RECEIVED, this.peerAddress
                            .getHostAddress());
                    // topMostVia.setHost(this.peerAddress
                    // .getHostAddress());
                ...
                if (hasRPort) {
                    ...
                    // topMostVia.setPort(this.peerPacketSourcePort);
                    // if (address != null){
                    //
                    // }
            ...
            // sipMessage).getMethod().equals(Request.REGISTER))
            // {
            ...
            // address = (SipUri)c.getAddress().getURI();
            // }else{
            //
            // logger.logInfo("contact.address is not
            // SipUri:"+c.getAddress().getClass().getName());
            // }
            // }else{
            // logger.logInfo("contact.address is null");
            // }
            //
            //
            // }else{
            // logger.logInfo("contact is null");
            // }
            //
            //
            //
            // if (address != null){
            // address.setHost(this.peerPacketSourceAddress
            // .getHostAddress());
            // address.setPort(this.peerPacketSourcePort);
            // }
            // }
