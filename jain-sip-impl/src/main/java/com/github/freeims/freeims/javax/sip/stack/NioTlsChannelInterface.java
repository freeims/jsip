...
/**
 * Common interface for TLS channels. We should be able to invoke some methods
 * in generic way.
 * 
...
public interface NioTlsChannelInterface {
	/**
	 * Be able to send already encrypted data or metadata or some SSL frame padding
	 * to comply with some extension
	 * 
	 * @param msg
	 * @throws IOException
	 */
