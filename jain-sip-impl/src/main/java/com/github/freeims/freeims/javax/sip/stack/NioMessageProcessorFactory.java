...
import com.github.freeims.freeims.javax.sip.ListeningPointExt;
                ...
                if (transport.equalsIgnoreCase(ListeningPoint.UDP)) {
                        ...
                        try {
                                Class<?> mpc = ClassLoader.getSystemClassLoader().loadClass(
                                                "org.freeims.javax.sip.stack.sctp.SCTPMessageProcessor");
                        ...
                        if ("true".equals(((SipStackImpl) sipStack).getConfigurationProperties()
                                        .getProperty("org.freeims.javax.sip.USE_TLS_GATEWAY"))) {
