 ...
 * request,
 * en-route to its destination. The header is populated with the Request-URI
 * received
 ...
 * registrar,
 * so both URIs can receive invitations to new sessions. When the user receives
 * an invitation
 * to join a session, he/she should be aware of which of the several registered
 * SIP URIs this
 * session was sent to.
 * </p>
 *
