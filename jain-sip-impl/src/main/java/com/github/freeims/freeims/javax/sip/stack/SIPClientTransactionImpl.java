...
import com.github.freeims.freeims.core.NameValueList;
...
import com.github.freeims.freeims.javax.sip.address.AddressImpl;
import com.github.freeims.freeims.javax.sip.header.Contact;
import com.github.freeims.freeims.javax.sip.header.Event;
import com.github.freeims.freeims.javax.sip.header.Expires;
import com.github.freeims.freeims.javax.sip.header.RecordRoute;
...
import com.github.freeims.freeims.javax.sip.header.TimeStamp;
...
import com.github.freeims.freeims.javax.sip.stack.IllegalTransactionStateException.Reason;
...
public class SIPClientTransactionImpl extends SIPTransactionImpl implements SIPClientTransaction {
  ...
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#setResponseInterface(com.github.freeims.freeims.javax.sip.stack.ServerResponseInterface)
   */
  @Override
  ...
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#getRequestChannel()
   */
  @Override
  ...
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#isMessagePartOfTransaction(com.github.freeims.freeims.javax.sip.message.SIPMessage)
   */
  @Override
  ...
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#sendMessage(com.github.freeims.freeims.javax.sip.message.SIPMessage)
   */
  @Override
  ...
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#processResponse(com.github.freeims.freeims.javax.sip.message.SIPResponse,
   *      com.github.freeims.freeims.javax.sip.stack.MessageChannel,
   *      com.github.freeims.freeims.javax.sip.stack.SIPDialog)
   */
  @Override
  ...
  private void inviteClientTransaction(SIPResponse transactionResponse,
    ...
    if (TransactionState._TERMINATED == this.getInternalState()) {
      ...
      if (dialog == null && statusCode >= 200 && statusCode < 300) {
        ...
        // for proxy, it happens that there is a race condition while the tx is getting
        // removed and
        // TERMINATED
        ...
        if (logger.isLoggingEnabled(LogWriter.TRACE_DEBUG))
          logger.logDebug("Client Transaction " + this + " branch id " + getBranch()
              + " has a early dialog and is in TERMINATED state");
   ...
   */
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#sendRequest()
   */
  @Override
  public void sendRequest() throws SipException {
    ...
    try {
      /*
       * This check is removed because it causes problems for load balancers ( See
       * issue
  ...
  public void fireRetransmissionTimer() {
    ...
    try {
      ...
      // PROCEEDING
      // Bug-fix for non-INVITE transactions not retransmitted when 1xx response
      // received
  ...
  public void fireTimeoutTimer() {
    ...
    if (TransactionState._COMPLETED != this.getInternalState()
      ...
      if (this.getMethod().equalsIgnoreCase(Request.CANCEL)) {
        ...
        if (inviteTx != null
            && ((inviteTx.getInternalState() == TransactionState._CALLING
                || inviteTx.getInternalState() == TransactionState._PROCEEDING))
   ...
   */
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#createCancel()
   */
  @Override
   ...
   */
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#createAck()
   */
  @Override
  ...
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#setViaPort(int)
   */
  @Override
  ...
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#setViaHost(java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#getViaPort()
   */
  @Override
  ...
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#getViaHost()
   */
  @Override
  ...
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#getOutgoingViaHeader()
   */
  @Override
  ...
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#clearState()
   */
  @Override
  ...
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#setState(int)
   */
  @Override
   ...
   */
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#terminate()
   */
  @Override
  ...
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#stopExpiresTimer()
   */
  @Override
  ...
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#checkFromTag(com.github.freeims.freeims.javax.sip.message.SIPResponse)
   */
  @Override
   ...
   */
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#getDialog()
   */
  @Override
  public Dialog getDialog() {
    // This is for backwards compatibility.
    Dialog retval = null;
    // get it in a local variable because the last response can be nullified and the
    // if condition
    // can throw NPE
   ...
   */
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#getDialog(java.lang.String)
   */
  @Override
   ...
   */
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#setDialog(com.github.freeims.freeims.javax.sip.stack.SIPDialog,
   *      java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#getDefaultDialog()
   */
  @Override
  public SIPDialog getDefaultDialog() {
    SIPDialog dialog = defaultDialog;
    // jeand if the dialog has been nullified then get the dialog from the saved
    // dialog id
  ...
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#setNextHop(javax.sip.address.Hop)
   */
  @Override
  ...
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#getNextHop()
   */
  @Override
  ...
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#setNotifyOnRetransmit(boolean)
   */
  @Override
  ...
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#isNotifyOnRetransmit()
   */
  @Override
  ...
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#alertIfStillInCallingStateBy(int)
   */
  @Override
  ...
  // jeand method use to cleanup eagerly all structures that won't be needed
  // anymore once the tx
  ...
  protected void cleanUpOnTimer() {
    if (isReleaseReferences()) {
      ...
      // we release the ref to the dialog asap and just keep the id of the dialog to
      // look it up in
      // the dialog table
      if (defaultDialog != null) {
        String dialogId = defaultDialog.getDialogId();
        // we nullify the ref only if it can be find in the dialog table (not always
        // true if the
      ...
      // for subscribe Tx we need to keep the last response longer to be able to
      // create notify from
      // dialog
  ...
  // from the stack
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#cleanUp()
   */
  @Override
  public void cleanUp() {
    if (isReleaseReferences()) {
  ...
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#getOriginalRequestFromTag()
   */
  @Override
  ...
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#getOriginalRequestCallId()
   */
  @Override
  ...
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#getOriginalRequestEvent()
   */
  @Override
  ...
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#getOriginalRequestContact()
   */
  @Override
  ...
  /**
   * @see com.github.freeims.freeims.javax.sip.stack.SIPClientTransaction#getOriginalRequestScheme()
   */
  @Override
