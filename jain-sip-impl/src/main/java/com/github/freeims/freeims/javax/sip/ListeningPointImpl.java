...
import com.github.freeims.freeims.javax.sip.stack.*;
...
public class ListeningPointImpl
        implements javax.sip.ListeningPoint, com.github.freeims.freeims.javax.sip.ListeningPointExt {
    ...
    public void sendHeartbeat(String ipAddress, int port) throws IOException {
        ...
        if (messageChannel instanceof ConnectionOrientedMessageChannel) {
            // RFC 5626 : schedule the keepaive timeout to make sure we receive a pong
            // response and notify the app if not
