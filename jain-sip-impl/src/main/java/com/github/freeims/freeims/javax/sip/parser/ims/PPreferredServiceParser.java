...
import com.github.freeims.freeims.javax.sip.header.ims.PPreferredService;
import com.github.freeims.freeims.javax.sip.header.ims.ParameterNamesIms;
...
public class PPreferredServiceParser extends HeaderParser implements TokenTypes {
     ...
     *         urn:urn-7:3gpp-service OR urn:urn-7:3gpp-application alone with no
     *         sub-services
     *         or sub-applications. This is bound to cause an error at the recepient
     *         later.
     *
     *         Sub-service and Application identifiers are not maintained by IANA
     *         and
     *         are organization/application dependent (Section 8.2). So we cannot
     *         gurantee what lies
     *         beyond the first sub-service or sub-application identifier. It should
     *         be the responsibility
     *         of the application to make sense of the entire URN holistically. We
     *         can only check for the
