...
public interface NetworkLayer {
        ...
        /**
         * Creates an SSL server with the specified port, listen backlog, and local IP
         * address to bind to.
         * Added by Daniel J. Martinez Manzano <dani@dif.um.es>
         *
         * @param port
        ...
        /**
         * Creates a stream SSL socket and connects it to the specified port number at
        ...
        /**
         * Set the sip stack impl so that the network layer can access it to query
         * properties
         * 
         * @param sipStackImpl
         */
