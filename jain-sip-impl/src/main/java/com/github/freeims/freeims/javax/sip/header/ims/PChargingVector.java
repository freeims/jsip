...
public class PChargingVector extends com.github.freeims.freeims.javax.sip.header.ParametersHeader
    ...
    public StringBuilder encodeBody(StringBuilder encoding) {
         ...
         */
        com.github.freeims.freeims.core.NameValue nv = getNameValue(ParameterNamesIms.ICID_VALUE);
        if (nv != null)
