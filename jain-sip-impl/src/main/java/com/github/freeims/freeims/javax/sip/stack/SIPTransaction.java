...
import com.github.freeims.freeims.javax.sip.TransactionExt;
...
public interface SIPTransaction extends TransactionExt {
  ...
  /**
   * Returns a flag stating whether this transaction is for a request that creates
   * a dialog.
   * 
   ...
   *                        the new integer value of the retransmit timer in
   *                        milliseconds.
   */
   ...
   *                        application data pointer to set. null clears the
   *                        applicationd
   *                        data pointer.
   * 
   */
